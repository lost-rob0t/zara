...
<hierarchy rotation=\"0\">
  ...
  <node text=\"\" content-desc=\"Choose APK\" class=\"android.widget.Button\" clickable=\"true\" enabled=\"true\" bounds=\"[0,40][180,100]\" />
</hierarchy>
"""
...
def test_capture_retains_same_state_text_twin_and_asserted_action_hash(tmp_path):
    ...
    action = next(node for node in twin["nodes"] if node["content_description"] == "Choose APK")
