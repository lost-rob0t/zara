...
async def test_cancellation_is_isolated_between_concurrent_tool_invocations():
    ...
    first_state = {
        "messages": [AIMessage(content="", tool_calls=[{
            "name": "first_effect", "args": {}, "id": "first-1", "type": "tool_call"
        }])],
        "turn_id": "turn-first",
        "tool_decisions": {},
    }
    second_state = {
        "messages": [AIMessage(content="", tool_calls=[{
            "name": "second_effect", "args": {}, "id": "second-1", "type": "tool_call"
        }])],
        "turn_id": "turn-second",
        "tool_decisions": {},
    }
...
async def test_async_tool_sees_signal_before_cancelled_error():
    ...
    state = {
        "messages": [AIMessage(content="", tool_calls=[{
            "name": "async_effect", "args": {}, "id": "async-1", "type": "tool_call"
        }])],
        "turn_id": "turn-async",
        "tool_decisions": {},
    }
...
async def test_rejected_tool_never_enters_cancellation_scope():
    ...
    state = {
        "messages": [AIMessage(content="", tool_calls=[{
            "name": "approved_effect", "args": {}, "id": "approved-1", "type": "tool_call"
        }])],
