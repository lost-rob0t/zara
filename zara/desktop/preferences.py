...
SETTING_VALIDATORS: Mapping[str, Callable[[Any], bool]] = {
    ...
    "tts.endpoint": _string,
    "tts.voice": _string,
    "voice_expert.max_source_seconds": _positive_number,
    "voice_expert.diarization_segmentation_model": _string,
    "voice_expert.diarization_embedding_model": _string,
    "voice_expert.diarization_cluster_threshold": _positive_number,
    ...
    "tools.youtube_search": _boolean,
    "tools.voice_list": _boolean,
    "tools.voice_plan": _boolean,
    "tools.voice_speak": _boolean,
    "tools.voice_narrate": _boolean,
    "tools.voice_analyze_youtube": _boolean,
    "tools.voice_clone_from_youtube": _boolean,
    "tools.voice_delete": _boolean,
