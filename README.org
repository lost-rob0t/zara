...
The repository ships a thin native Emacs client in =emacs/zara.el=.  It keeps
Zara's normal client/runtime boundary intact, provides a native chat buffer,
and can register a confirmation-gated =ZaraAsk= gptel tool.  See
[[file:wiki/emacs.org][wiki/emacs.org]].
...
| [[file:wiki/emacs.org][wiki/emacs.org]] | Native Emacs chat client and gptel delegation boundary. |
