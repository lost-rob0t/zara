...
[[https://github.com/lost-rob0t/zara/actions/workflows/ci.yml][https://github.com/lost-rob0t/zara/actions/workflows/ci.yml/badge.svg?branch=master]]
[[https://github.com/lost-rob0t/zara/actions/workflows/android-latest.yml][https://github.com/lost-rob0t/zara/actions/workflows/android-latest.yml/badge.svg?branch=master]]
[[https://codecov.io/gh/lost-rob0t/zara][https://codecov.io/gh/lost-rob0t/zara/graph/badge.svg?branch=master]]
...
The Python phase records line and branch coverage for =zara/=, prints uncovered paths, and writes =coverage.xml= plus =coverage.json= into the regression artifacts. CI uploads the exact-head report and publishes it to the coverage badge above. The measured repository baseline is used as a non-regression floor; new coverage should come from meaningful contract/failure-path tests, not duplicate execution-only tests.
...
See [[file:docs/development.org][docs/development.org]] and [[file:docs/testing.org][docs/testing.org]].
...
| [[file:docs/testing.org][docs/testing.org]] | Test layers, branch coverage, artifacts, and coverage-floor policy. |
...
| [[file:wiki/testing.org][wiki/testing.org]] | Testing chapter in the user/maintainer book layer. |
