...
#
# This focused gate intentionally includes every #129-owned ZARA/1 protocol,
# transport, reconnect/idempotency, backpressure/status, server-endpoint, and
# dependency-neutral ZARA-SYNC/1 semantic contract test so a narrow run cannot
# silently omit a later protocol slice.
