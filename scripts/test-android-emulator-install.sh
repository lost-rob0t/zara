...
# legacy symbolic-owner claim, restart cancellation fencing, bounded v2
# verified-outcome replay, and application-owned embedding preference storage on
# the same emulator used for acceptance. The embedding fixture starts the real
