...
for apk in "$phone_apk" "$code_apk" "$termux_bridge_apk" "$org_apk" "$wear_apk" "$voice_apk"; do
...
echo "android/wear/code/termux/org gate ok: $phone_apk $code_apk $termux_bridge_apk $org_apk $wear_apk $voice_apk"
