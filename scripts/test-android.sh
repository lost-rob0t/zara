...
for apk in "$phone_apk" "$org_apk" "$org_todo_apk" "$org_reminder_apk" "$org_sync_apk" "$wear_apk"; do
...
echo "android/wear/org gate ok: $phone_apk $org_apk $org_todo_apk $org_reminder_apk $org_sync_apk $wear_apk"
