...
- Native Emacs integration now provides a Zara chat buffer, canonical CLI/daemon delegation, status inspection, and an optional confirmation-gated `ZaraAsk` gptel tool.
