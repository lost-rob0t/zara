...
- Android's embedded Trealla bridge now honors `pl_query`'s successful no-error return value, so valid local Prolog queries proceed while actual native query errors still fail closed.
