...
- Android now ships a standalone loopback-only Ollama-compatible `llm-serve` APK for verified on-device models, while Zara keeps authenticated remote/cloud AI available through Auto and Remote modes.
