...
- Android Local conversations persist on-device in portable SQLite history, can be reopened from Recents, and remain compatible with Desktop without remote sync.
