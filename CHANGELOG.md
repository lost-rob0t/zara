...
- New Zara configs now enable a local-only beta tester console on `127.0.0.1:8787`; it exposes read-only runtime/theme views and shares the same semantic theme registry as Desktop instead of maintaining a second theme authority.
