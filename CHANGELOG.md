...
- Android Assistant voice now refuses Remote capture without ready enrollment and an authenticated connected session, and refuses Auto capture when neither local nor remote runtime is ready, instead of starting work against a nonexistent backend.
