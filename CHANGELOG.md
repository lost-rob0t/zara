...
- Expert invocation now fails closed when a successful handler violates its declared output schema, preserving observed usage and effect receipts as terminal unknown state so restart replay does not execute it again.
