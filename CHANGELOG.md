...
- Android home-screen widgets now expose Assistant, Runtime, and Quick Actions views with bounded data-only Prolog styling, canonical route ingress, stale-safe runtime truth, responsive resize behavior, and Appearance import/export/reset controls.
